...
QT_MOC_LITERAL(1, 13, 8), // "send_rst"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 2) // "ba"

    },
    "VideoHandler\0send_rst\0\0ba"
};
...
void VideoHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (VideoHandler::*_t)(QByteArray );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VideoHandler::send_rst)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void VideoHandler::send_rst(QByteArray _t1)
{
